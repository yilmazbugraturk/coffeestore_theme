...
* `coffee_store_enqueue_style`                 enqueue style
* `coffee_store_enqueue_theme_style`           load theme-specific style (default: load)
* `coffee_store_load_textdomain`               load theme's textdomain
* `coffee_store_register_menus`                register the theme's default menu location
* `coffee_store_add_theme_support`             register the various supported features
* `coffee_store_add_woocommerce_support`       register woocommerce features, including product-gallery zoom, swipe & lightbox features
* `coffee_store_register_elementor_locations`  register elementor settings
* `coffee_store_content_width`                 set default content width to 800px
* `coffee_store_page_title`                    show\hide page title (default: show)
* `coffee_store_viewport_content`              modify `content` of `viewport` meta in header
...
* Tweak: Remove comments in `style.min.css` output ([#179](https://github.com/elementor/coffee-theme/issues/179))
...
* Tweak: Added `input[type="url"]` to CSS reset rules ([#109](https://github.com/elementor/coffee-theme/issues/109))
...
= 2.2.1 - 2019-09-10 =
* Tweak: Added max width to `wp-caption` ([#91](https://github.com/elementor/coffee-theme/issues/91))
* Tweak: Added support of `wp_body_open`

= 2.2.0 - 2019-07-22 =
* Tweak: Added viewport content filter ([#49](https://github.com/elementor/coffee-theme/issues/49))
...
* Tweak: Remove header tags with `coffee_store_page_title` filter
...
* New: Added `coffee_store_page_title` filter for show\hide page title
* New: Added `coffee_store_enqueue_theme_style` filter for enqueue theme-specific style
...
= 2.0.5 - 2019-05-21 =
* New: Inroducing [Hello Theme Child](https://github.com/elementor/coffee-theme-child)
...
= 2.0.2 - 2019-05-13 =
* Tweak: Added `coffee_store_content_width` filter, as per WordePress best practice
...
* Tweak: Change functions.php methods names prefix from `coffee_store_theme_` to `coffee_store_`
...
* New: Added `coffee_store_theme_load_textdomain` filter for load theme's textdomain
* New: Added `coffee_store_theme_register_menus` filter for register the theme's default menu location
* New: Added `coffee_store_theme_add_theme_support` filter for register the various supported features
* New: Added `coffee_store_theme_add_woocommerce_support` filter for register woocommerce features, including product-gallery zoom, swipe & lightbox features
* New: Added `coffee_store_theme_enqueue_style` filter for enqueue style
* New: Added `coffee_store_theme_register_elementor_locations` filter for register elementor settings
